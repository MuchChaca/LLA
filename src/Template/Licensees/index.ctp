<fieldset>
    <legend><h1>Les licenciés</h1></legend>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                    <td><?= $this->Html->link('Athlète', ['controller' => 'Athletes', 'action' => 'view', $athlete->id], ['class' => 'lienhyp']) ?></td>
                    ...
                    <td><?= $this->Html->link($athlete->birth_date->format('j/m/Y'), ['controller' => 'Athletes', 'action' => 'view', $athlete->id], ['class' => 'lienhyp']) ?></td>
                </a>    
                <td>
            ...
            <tr>
                <td><?= $this->Html->link('Entraineur', ['controller' => 'Trainers', 'action' => 'view', $trainer->id], ['class' => 'lienhyp']) ?></td>
                ...
                <td><?= $this->Html->link($trainer->birth_date->format('j/m/Y'), ['controller' => 'Trainers', 'action' => 'view', $trainer->id], ['class' => 'lienhyp']) ?></td>
                <td>
                    <?= $this->Html->link($this->Html->image('pen-ico.ico',['class' => 'a fa-pencil button alterar', 'height' => '20px', 'alt' => 'Modifier', 'title' => 'Modifier']),
